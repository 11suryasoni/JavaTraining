...
This LsOld Class is used to replicate the ls of linux.
...
public class LsOld {
	...
	/**
	 * ls -T will sorts Descending order the file by modification time, showing the last edited file last.
	 * @param path
	 */
	...
	/**
	 * ls-color recognizing the file type by the color in which it gets displayed is a kind in classification of file.
 	 * @param path
	 */
	...
	/**
	 * ls -1 will display One File Per Line
	 * @param path
	 */
	...
	/**
	 * ls -a show all the hidden files in the directory, use ‘-a option’. Hidden files in Unix starts with ‘.’ in its file name"
	 * @param path
	 */
	...
	/**
	 * ls-X is used to print the files ordered by name in ascending order"
	 * @param path
	 */
	...
	/**
	 * ls-la combination of ls -l (use a long listing format) and ls -a (do not ignore entries starting with .).
	 * @param path
	 */
	...
	/**
	 * ls -l method to list the contents of the directory in a table format with columns.
	 * @param path
	 */
	...
	public static void man(){
		...
		System.out.print("ls - ls is a Linux shell command that lists directory contents of files and directories.");
		...
		System.out.print("ls-l - To show long listing information about the file/directory. ");
		...
		public static void main(String []args)
		{
			...
			// ls options  are implemented in switch.
