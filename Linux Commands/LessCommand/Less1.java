...
This less1 Class is used to print contents of a given input file.

@Author -> suryaps (Surya prakash soni)
 */

package Day1_LessCommand;
...
public class Less1 {
    ...
    /**
     * Search method is used to Search input string in content of file.
     */
	
	public static void search(String path,String input)throws FileNotFoundException
	{	
	    long count=0;
