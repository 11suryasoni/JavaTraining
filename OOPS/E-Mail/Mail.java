...
public class Mail {
    ...
    public static void main(String[] args) {
        ...
        logg.info("E-Mail Program Initiated");
        logg.info("Initializing ID & Password");
        final String username = "suryasonirewa@gmail.com";
        final String password = "dlfp focd shbq rdja";
